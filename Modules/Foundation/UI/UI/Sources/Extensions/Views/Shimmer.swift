...
// Reference: https://github.com/markiv/SwiftUI-Shimmer?ref=iosexample.com
...
extension View {
  ...
  ///   `.linear(duration: 1.5).repeatForever(autoreverses: false)`.
  @ViewBuilder
  public func shimmering(active: Bool = true, animation: Animation = Shimmer.defaultAnimation) -> some View {
    if active {
